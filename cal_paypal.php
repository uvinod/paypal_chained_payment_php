...
$Receiver = array(
				...
				'Email' => 'mli@medialabs.com.sg', 												// Receiver's email address. 127 char max.
...
$Receiver = array(
				'Amount' => '650.00', 											// Required.  Amount to be paid to the receiver.
				'Email' => 'gramercy_test@mli.com', 												// Receiver's email address. 127 char max.
				'InvoiceID' => '', 											// The invoice number for the payment.  127 char max.
				'PaymentType' => '', 										// Transaction type.  Values are:  GOODS, SERVICE, PERSONAL, CASHADVANCE, DIGITALGOODS
				'PaymentSubType' => '', 									// The transaction subtype for the payment.
				'Phone' => array('CountryCode' => '', 'PhoneNumber' => '', 'Extension' => ''), // Receiver's phone number.   Numbers only.
